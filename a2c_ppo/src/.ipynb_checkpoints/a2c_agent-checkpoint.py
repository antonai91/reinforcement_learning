...
class Agent:
    def __init__(self, model, save_path=None, load_path=None, lr=1e-4, gamma=0.99, value_c=0.5, entropy_c=1e-4, clip_ratio=0.2, std_adv=True, agent="PPO"):
        ...
        for update in range(updates):
            ...
            with tf.GradientTape() as tape:
                ...
                if self.agent == "A2C":
                    ...
                    logit_loss = self._logits_loss_ppo(old_logits, logits, actions, advs, wrapper.action_space.n)
                else:
